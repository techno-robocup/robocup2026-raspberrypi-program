...
MIN_BLACK_LINE_AREA: Final[int] = 3000  # BE CAREFUL WHEN REWRITING THIS VALUE
...
GREEN_MARK_Y_THRESHOLD_RATIO: Final[
    float] = 1 / 2  # Mark must be in bottom third
...
GREEN_AHEAD_SLOWDOWN_SPEED: Final[
    int] = 1650  # Motor speed cap when green mark predicted ahead
