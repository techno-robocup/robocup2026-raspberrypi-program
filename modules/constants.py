...
MIN_BLACK_LINE_AREA: Final[int] = 50000  # BE CAREFUL WHEN REWRITING THIS VALUE
...
MIN_OBJECT_AVOIDANCE_LINE_AREA: Final[int] = 50000
...
GREEN_MARK_Y_THRESHOLD_RATIO: Final[
    float] = 3 / 5  # Mark must be in bottom third
